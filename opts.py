...
def parse_args():
    ...
    #################### 使用这里的参数去更改训练方式 #######################
    parser.add_argument('--train_model', type=str, default="swl", help="agb, wgb, swl, mgda")
    ...
    parser.add_argument('--data_root', type=str, default="/home/data/GNN/")
    parser.add_argument('--save_dir', type=str, default="debug")
    parser.add_argument('--dataset', type=str, default="NCI1")
    parser.add_argument('--epoch_select', type=str, default='test_max')
    parser.add_argument('--model', type=str, default="CausalGIN", help="GCN, GIN")
